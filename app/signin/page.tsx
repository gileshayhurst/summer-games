    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-6">
      <div className="max-w-sm w-full">
        ...
        <button
          ...
          disabled={pending}
          className="w-full bg-white border border-stone-300 text-stone-900 font-black py-3 rounded-full flex items-center justify-center gap-2 hover:bg-stone-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
